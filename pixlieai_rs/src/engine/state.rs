...
pub struct PiState {
    ...
    pub labels: RwLock<HashMap<String, LabelId>>, // All entity types that are in the engine
    pub nodes: RwLock<Vec<Node>>,                 // All nodes that are in the engine
    // pub storage_root: String,
    pub nodes_by_label_id: RwLock<HashMap<LabelId, Vec<NodeId>>>,
    pub entity_type_last_run: RwLock<HashMap<LabelId, DateTime<Utc>>>,
}
