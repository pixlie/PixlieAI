...
const DUMMY_DATA: IData[] = [
  ...
  },
  {
    ...
    items: [
      { name: "Name", news: "[Recent news]", value: 1, term: "[URL]" },
      { name: "Name", news: "[Recent news]", value: 2, term: "[URL]" },
      { name: "Name", news: "[Recent news]", value: 3, term: "[URL]" },
      { name: "Name", news: "[Recent news]", value: 4, term: "[URL]" },
      { name: "Name", news: "[Recent news]", value: 5, term: "[URL]" },
      { name: "Name", news: "[Recent news]", value: 6, term: "[URL]" },
      { name: "Name", news: "[Recent news]", value: 7, term: "[URL]" },
      { name: "Name", news: "[Recent news]", value: 8, term: "[URL]" },
      { name: "Name", news: "[Recent news]", value: 9, term: "[URL]" },
      { name: "Name", news: "[Recent news]", value: 10, term: "[URL]" },
    ],
  },
];
