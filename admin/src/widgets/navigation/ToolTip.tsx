...
const ToolTip: Component<ToolTipProps> = (props) => {
  return (
    <div class="relative group">
      ...
      <div class="absolute hidden group-hover:block top-full left-1/2 transform -translate-x-1/2 mt-2.5 px-2 py-1 text-sm text-white bg-gray-900 rounded-lg whitespace-nowrap">
        {props.text}
