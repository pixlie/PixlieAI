...
const ICONS: Record<string, () => JSX.Element> = {
  ...
  "brand-calendly": () => (
    <img
      src="https://cdn.brandfetch.io/idbJpTKFPT/theme/dark/symbol.svg?c=1dxbfHSJFAPEGdCLU4o5B"
      class="h-6 w-6"
    />
  ),
  "brand-discord": () => (
...
const Icon: Component<IPropTypes> = (props) => (
  <div class={`${props.color ?? ""}`}>{ICONS[props.name]()}</div>
);
