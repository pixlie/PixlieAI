...
impl Objective {
    ...
    pub fn process(
        ...
        // We want to match every crawled (and yet unprocessed) content and check if it matches the
        // given objective. If it does, crawling for a domain can continue, else it can stop
        Ok(())
    }
